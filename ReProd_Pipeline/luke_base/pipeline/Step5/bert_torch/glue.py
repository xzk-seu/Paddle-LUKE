    ...
    def __init__(
        ...
        Args:
          ...
          data_dir: `string`, the path to the folder containing the tsv files in the
            downloaded zip
          citation: `string`, citation for the dataset set
          url: `string`, url for information about the dataset set
...
class Glue(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        ...
        GlueConfig(
            ...
            language inference dataset. Each pair is human-annotated with a similarity score
            from 1 to 5."""),
            text_features={
                "sentence1": "sentence1",
                "sentence2": "sentence2",
        ...
        GlueConfig(
            ...
            the SNLI corpus as 550k examples of auxiliary training dataset."""),
            **_MNLI_BASE_KWARGS, ),
        GlueConfig(
        ...
        GlueConfig(
            ...
            entailment challenges. We combine the dataset from RTE1 (Dagan et al., 2006), RTE2 (Bar Haim
        ...
        GlueConfig(
            ...
            between them (65% not entailment). Also, due to a dataset quirk, the development set is adversarial:
